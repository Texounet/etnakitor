...
-- Généré le :  Jeu 07 Janvier 2016 à 14:25
...
INSERT INTO `personnes` (`id`, `result`, `sexe`, `cheveux`, `couleur cheveux`, `yeux`, `service`, `lunette`) VALUES
(1, 'Robin', 'M', 'court', 'brun', 'marron', 'pedago', 'N'),
(2, 'Stéphanie GUBERN', 'F', 'long', 'blond', 'marron', 'pedago', 'N');
